...
long_description 'Installs/Configures load balancer server with nginx'
version '0.1.0'
...
# a Supermarket.
#
source_url 'https://github.com/kdeyko/EPAM-tasks/tree/master/Chef/chef-repo/cookbooks/lb'
